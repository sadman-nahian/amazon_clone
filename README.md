A fully functional e-commerce web application replicating core features of Amazon. This project was built using **React**, **Firebase**, and **CSS** to demonstrate proficiency in front-end and back-end development.
